...
window.onload = function () {
    ...
    networkObject.registerQuery('/data?type=sensors&data={"label":"net_clients"}&age=300', serverFQDN1, '55555', true);
    networkObject.registerQuery('/data?type=sensors&data={"label":"net_clients"}&age=300', serverFQDN2, '55555', true);
    ...
    networkObject.setQueryInterval('/data?type=sensors&data={"label":"net_clients"}&age=300', 3000);
